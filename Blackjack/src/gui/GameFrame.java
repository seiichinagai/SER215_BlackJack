...
public class GameFrame {
  ...
  private void initialize() {
     ...
     */
    /*
     * JButton numDecksButton = new JButton("Confirm Number"); numDecksButton.addActionListener(new
     * ActionListener() { public void actionPerformed(ActionEvent e) { int number = 0; try { number
     * = Integer.parseInt(numDecksTextField.getText()); if ((number < 1) || (number > 8)) throw new
     * NumberFormatException(); shoeSet = true; } catch (NumberFormatException num){
     * numDecksTextField.setText("Invalid Number"); }
     * 
     * if (shoeSet){ s.setDecks(number); JLabel numDecksLabel = new JLabel(""+number);
     * numDecksLabel.setBounds(lblNumberOfDecks.getX()+lblNumberOfDecks.getWidth()+2,
     * lblNumberOfDecks.getY(), 86, 20); frame.getContentPane().add(numDecksLabel);
     * numDecksButton.setVisible(false); numDecksTextField.setVisible(false); } } });
     * numDecksButton.setBounds(219, 527, 129, 23); frame.getContentPane().add(numDecksButton);
     */
